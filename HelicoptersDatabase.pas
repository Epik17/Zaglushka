...
Gmax  //максимальный полетный вес
{, NeraspUZemli, //располагаема€ мощность у земли, л.с.
  NeRasch,  //расчетна€ мощность, л.с.
  TRasch    //расчетна€ т€га, кг
  } : Real;
end;
...
mi8mtv5tv3117vm : THelicopterParameters = (356,13000,13700,0.5,1.5,1.0,0.234,3980,6000,250,130,0.3672,12000,13500{,2000,1800,13000});
mi8mtv5vk2500 : THelicopterParameters = (356,13000,15200,0.5,1.5,0.77143,0.08,4300,6000,250,130,0.3474,12000,15500{,2000,1800,13000});
mi28 : THelicopterParameters = (232,11000,13852,0.5,2.8,0.922,0.28,2950,5250,305,110,0.4,10800,11500{,2000,1800,13000});
ka226 : THelicopterParameters = (132,3100,3920,0.5,1.5,0.315,0.1077,2600,6500,210,31,0.444,3000,3500{,2000,1800,13000});
