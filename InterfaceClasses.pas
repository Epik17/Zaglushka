...
g_ManevrTypesCount = 6;
g_ManevrNames :array[1..g_ManevrTypesCount] of string = ('Горизонтальный полет','Горка','Пикирование','Левый вираж', 'Правый вираж', 'Разгон в горизонте');
g_HelicopterTypes : array [1..g_HelicoptersCount] of string = ('Ансат-У','Ми-26','Ка-226','Ми-28Н','Ми-8МТВ-5','Ми-8АМТШ');


type TManevrTypes = (mtUndefined, mtHorizFlight, mtGorka, mtPikirovanie,mtLeftVirage,mtRightVirage,mtHorizRazgon);
...
begin
  ...
  // ShowMessage('TManevrList.Create(fileContent: TStrings):' + Manevr.ParametersString);
   Self.Add(Manevr)
  end;
